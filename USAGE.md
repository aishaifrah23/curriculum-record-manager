...
This guide provides a step-by-step command workflow to demonstrate the key features of the **Campus Course & Records Manager (CRM).**

---

## 🚀 Sample Command Workflow

This is a typical session demonstrating how to use the CRM application after starting it.  
...
```text
Starting data import from C:\...\CRM\test-data...
